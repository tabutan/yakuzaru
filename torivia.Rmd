...
```{r, TaneYakuClimate, echo=FALSE, fig.cap="屋久島と種子島の気象データの比較<br>公開されている気象庁の過去の観測データからダウンロードし分析した。分析データは、屋久島観測所（＠屋久島町小瀬田）と種子島観測所（＠西之表市西之表）のデータ、2020年から2022年までの3年間のデータを用いた。"}
library(tidyverse)
