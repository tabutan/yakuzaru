...
## ヤクシマザルのお隣さん
>屋久島の隣にある種子島には少なくとも大正時代までニホンザルがいた[@hanya2000]
...
日本動物園水族館協会の[ウェブサイト](https://www.jaza.jp/animal/search?_method=true&page=45)によると、2024年1月現在、平川動物公園（鹿児島市）と沖縄こどもの国（沖縄市）でヤクシマザルが飼育されている。日本モンキーセンターでも飼育されており、焚火に当たるサルとして有名。
